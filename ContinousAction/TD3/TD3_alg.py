from TD3.Actor_Critic import *
import  torch
import torch.nn as nn

class TD3:

    def __init__(self,actor,critic1,critic2,buffer,decay_upd,dev, t_policy_noise=0.2,t_noise_clip=0.5 ,actor_update=2,discount=0.99):
    ...
    def update(self,step):
        ...
        Q_target = spl_rwd + (1- spl_done) * self.discount * target  # estimate maxQ given optimal action at next state in reply
